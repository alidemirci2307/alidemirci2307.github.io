...
<head>
  ...
  <style>
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
    ...
    .hero-bg span{position:absolute;border-radius:50%;opacity:.07;animation:float 8s ease-in-out infinite}
    .hero-bg span:nth-child(1){width:320px;height:320px;background:#3b82f6;top:-100px;left:-80px;animation-delay:0s}
    .hero-bg span:nth-child(2){width:210px;height:210px;background:#8b5cf6;top:10px;right:-50px;animation-delay:-3s}
    .hero-bg span:nth-child(3){width:160px;height:160px;background:#ec4899;bottom:-50px;left:45%;animation-delay:-5.5s}
    ...
    .hero h1{font-size:clamp(1.8rem,4vw,2.8rem);font-weight:800;letter-spacing:-1px;opacity:0}
    .hero-sub{margin-top:8px;font-size:1.05rem;opacity:0;color:rgba(255,255,255,.75)}
    .hero-meta{margin-top:24px;display:flex;align-items:center;justify-content:center;gap:10px;flex-wrap:wrap;opacity:0}
...
gsap.from('#hero-sub',   {duration:.8,  y:20, opacity:0, ease:'power3.out', delay:.4});
gsap.from('#hero-meta',  {duration:.8,  y:15, opacity:0, ease:'power3.out', delay:.55});
